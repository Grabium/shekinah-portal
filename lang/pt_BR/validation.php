...
return [
    ...
    */
    ...
    | Isso torna rápido especificar uma linha de idioma customizada para
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para trocar o nosso placeholder
    | de atributo por algo mais amigável, como "Endereço de E-mail" ao invés
    | de "email". Isso simplesmente ajuda a tornar nossa mensagem mais expressiva.
    |
    */
